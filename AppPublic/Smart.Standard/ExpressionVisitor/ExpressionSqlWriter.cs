...
namespace Smart.Standard.ExpressionVisitor
{
    ...
    public class ExpressionSqlWriter : ExpressionVisitor
    {
        ...
        protected override Expression VisitConstant(ConstantExpression c)
        {
            ...
            //{
            //    _mSb.AppendFormat("{0}",(int)c.Value);
            //}
            ...
            else
            {
                switch (Type.GetTypeCode(value.GetType()))
                {
                    ...
                    case TypeCode.DateTime:
                        _mSb.AppendFormat("'{0:yyyy-MM-dd HH:mm:ss.fff}'", (DateTime)c.Value);
                        break;
        ...
        protected override Expression VisitMethodCall(MethodCallExpression m)
        {
            ...
            //        //Visit(m.Object);
            //        _mSb.Append("(");
            //        if (m.Object != null) _mSb.Append(m.Object.ToString().Split('.')[1]);
            //        //Visit(m.Object);
            //        _mSb.Append("&");
            //        Visit(m.Arguments[0]);
            //        _mSb.Append("=");
            //        //var i = m.Arguments[0].GetPropertyValue("Value").CastTo<int>();
            //        Visit(m.Arguments[0]);
            //        _mSb.Append(")");
            //        return m;
