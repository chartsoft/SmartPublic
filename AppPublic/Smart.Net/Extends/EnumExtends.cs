...
using EnumDescription = Smart.Net45.Attribute.EnumDescription;
...
namespace Smart.Net45.Extends
{
    ...
    public static class EnumExtends
    {
        ...
        /// 列标签显示
        /// </summary>
        public static string GetFlagShow<TEnum>( this TEnum enumValue, string spliter=",") where TEnum : struct
        {
            return EnumDescription.GetFlagShow(enumValue, spliter);
        }
