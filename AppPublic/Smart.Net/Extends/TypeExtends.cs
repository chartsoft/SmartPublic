...
namespace Smart.Net45.Extends
{
    ...
    public static class TypeExtends
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Type> GetTypesByInterface(this Type interfaceType)
        {
        ...
        /// <returns></returns>
        public static IEnumerable<Type> GetTypesByInterface(this Type interfaceType, string dllName)
        {
            return Assembly.Load(dllName).GetTypes().Where(x => interfaceType.IsAssignableFrom(x) && x.IsClass && !x.IsAbstract);
        }
        /// <summary>
        /// 获取所有基类的子类
        /// </summary>
